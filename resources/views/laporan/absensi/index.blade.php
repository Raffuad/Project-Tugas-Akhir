        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="GET" action="{{ route('laporan.absensi.index') }}" class="mb-6 flex flex-wrap items-end gap-4">
                        <div>
                        ...
                        {{-- Tombol Export Excel --}}
                        <a href="{{ route('laporan.absensi.export', ['bulan' => $bulan, 'tahun' => $tahun]) }}"
